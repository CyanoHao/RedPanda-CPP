...
private:
    bool tryLoadThemeFromDir(const QString &dir, const QString &themeName, PAppTheme &theme);
    void loadThemesFromDir(const QString &dir, std::set<PAppTheme, ThemeCompare> &themes);
